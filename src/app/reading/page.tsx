          ...
          <div className="glass rounded-xl sm:rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <button className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 glass-light text-slate-300 rounded-lg sm:rounded-xl hover:bg-slate-700/50 transition-all duration-200 text-xs sm:text-sm font-medium active:scale-95">
            ...
            <div className="sm:hidden mt-4">
              <div className="flex items-center justify-between gap-2">
                ...
                {/* Next Button */}
                <button
                  onClick={() => currentIndex < sampleReadingContent.length - 1 && setCurrentIndex(currentIndex + 1)}
